This repository was developed by a code-along of the MLOps course by Data Talks Club [Zoomcamp ](https://github.com/DataTalksClub/mlops-zoomcamp). Implementations of the assignments are also included in each week repository.
